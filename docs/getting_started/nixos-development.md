...
- Blackwell (sm_100/sm_120) support for RTX 5090
...
- RTX 5090 Blackwell optimized CUDA architecture (sm_100/sm_120)
...
The flake uses nixos-25.11 to avoid glibc compatibility issues with CUDA 12.9.
...
```bash
CUDA_HOME=/nix/store/.../cuda-merged-12.9
VLLM_TARGET_DEVICE=cuda
MAX_JOBS=20
VIRTUAL_ENV_PROMPT=vllm-dev
TORCH_CUDA_ARCH_LIST=10.0;12.0  # Blackwell support
```
